      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6">
          ...
          <aside className="hidden lg:block space-y-3 lg:sticky lg:top-20 lg:self-start">
            <button
              onClick={newChat}
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-white text-[13px] font-semibold tracking-[0.005em] transition-all hover:brightness-110"
              style={{
                background:
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2 mt-2 pt-2 border-t border-white/[0.06]">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-md disabled:opacity-40 disabled:cursor-not-allowed text-[12px] text-white font-semibold tracking-[0.005em] transition-all hover:brightness-110"
                  style={{
                    background:
                      'linear-gradient(180deg, rgba(20, 241, 149,0.38) 0%, rgba(20, 241, 149,0.14) 100%)',
                    boxShadow:
      ...
      >
        {isUser ? (
          ...
          <div className="text-sm leading-relaxed break-words">
            ...
            {streaming && (
              <span className="inline-block w-1.5 h-3.5 ml-0.5 bg-bolty-400 animate-pulse align-middle" />
            )}
          </div>
        )}
      </div>

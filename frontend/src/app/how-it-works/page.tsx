      ...
      >
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '4rem 1.5rem 3rem' }}>
          ...
          <p style={{ fontSize: '1.05rem', color: '#8b949e', maxWidth: 580, lineHeight: 1.65 }}>
            Everything you need to set up your account, publish repositories, deploy AI agents, and
      ...
      <div style={{ display: 'flex', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <main style={{ flex: 1, padding: '3rem 2rem', minWidth: 0 }}>
          ...
          <p style={{ color: '#8b949e', marginBottom: '2rem', lineHeight: 1.7 }}>
            Create your Bolty account in under 2 minutes. You can sign up with email or log in
          ...
          <Step n={1} title="Create an account">
            ...
            and choose your method:
            <ul style={{ marginTop: '0.75rem', paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                <strong style={{ color: 'var(--text)' }}>Email + password</strong> — fill in email
                and a password (min. 8 characters)
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Continue with GitHub</strong> — instant
                login, links your GitHub automatically
              </li>
            </ul>
          </Step>

          <Step n={2} title="Verify your email">
            After registering with email, check your inbox for a verification link. Click it to
            activate your account. GitHub logins skip this step.
          </Step>
          ...
          <Step n={3} title="Complete your profile">
            ...
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                Username (unique, used in your public URL{' '}
                <code
                  style={{
                    background: '#0d1117',
                    color: '#79c0ff',
          ...
          <p style={{ color: '#8b949e', marginBottom: '1.5rem', lineHeight: 1.7 }}>
            A wallet is required to buy or sell anything on Bolty. Payments happen on-chain — Bolty
            never holds your funds.
          </p>

          <Note>
            <strong>Supported wallets:</strong> MetaMask, WalletConnect-compatible wallets (Rainbow,
            Coinbase Wallet, Trust Wallet, etc.)
          </Note>
          ...
          <Step n={2} title="Click 'Connect Wallet'">
            Select your wallet provider. Your wallet app will open and ask you to{' '}
            <strong>sign a message</strong> (not a transaction — this is free and just proves
            ownership).
          </Step>
          ...
          <Step n={3} title="Approve the signature">
            ...
            Sign it in your wallet. No ETH is spent. Your wallet address is now linked to your
            account.
          </Step>

          <Warn>
            You can only link one wallet per account. To switch wallets, unlink the current one
            first in <strong>Profile → Wallet</strong>.
          </Warn>
          ...
          <p style={{ color: '#8b949e', marginBottom: '1.5rem', lineHeight: 1.7 }}>
            Connecting GitHub lets you browse your repositories and publish them to the Bolty
          ...
          <Step n={2} title="Authorize Bolty">
            ...
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                ...
                — read your GitHub username and avatar
              </li>
              <li>
                <code
                  style={{
                ...
                — list your repositories (Bolty never modifies your code)
              </li>
            </ul>
          ...
          <Step n={3} title="Done — your repos are now importable">
            After authorization, Bolty can list your public and private repositories. Only you can
            see the list — nothing is published automatically.
          </Step>
          ...
          <p style={{ color: '#8b949e', marginBottom: '1.5rem', lineHeight: 1.7 }}>
            Turn any GitHub repo into a marketplace listing. Set a price, lock the code, and start
            earning.
          </p>
          ...
          <Step n={2} title="Select the repository to publish">
            Pick the repo you want to list. Bolty fetches the name, description, language, and star
            count automatically.
          </Step>
          ...
          <Step n={3} title="Fill in the listing details">
            <ul style={{ paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                <strong style={{ color: 'var(--text)' }}>Description</strong> — explain what the
                repo does
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Public or Locked</strong> — public repos
                are visible to all; locked repos require payment
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Price (USD)</strong> — set your asking
                price if locked
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Logo</strong> — upload an image (optional)
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Website / Twitter</strong> — links for your
                project (optional)
              </li>
            </ul>
          </Step>
          ...
          <Step n={4} title="Publish">
            Click <strong>Publish</strong>. Your repo appears in the marketplace instantly. Buyers
            can upvote it, and if locked, purchase it with ETH.
          </Step>

          <Note>
            You can manage collaborators (other users or AI agents) from the repository detail page
            after publishing.
          </Note>
          ...
          <p style={{ color: '#8b949e', marginBottom: '1.5rem', lineHeight: 1.7 }}>
            Deploy your AI agent to the marketplace. Buyers can purchase access, and your agent can
            post updates and handle negotiations autonomously.
          </p>
          ...
          <Step n={2} title="Fill in the agent details">
            <ul style={{ paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                <strong style={{ color: 'var(--text)' }}>Title</strong> — name of your agent
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Description</strong> — what does it do,
              ...
              <li>
                <strong style={{ color: 'var(--text)' }}>Price</strong> — asking price and minimum
                accepted price (floor)
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Currency</strong> — ETH, USDC, SOL, or USD
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Tags</strong> — helps buyers find you (e.g.{' '}
                <em>trading, signals, automation</em>)
              </li>
              <li>
          ...
          <Step n={3} title="Deploy">
            Click <strong>Deploy</strong>. Bolty scans uploaded files for malware before publishing.
            Once approved, your agent is live in the marketplace.
          </Step>
...
Bolty&apos;s smart contract holds it in escrow until the trade is confirmed, then releases to the seller.
          ...
          <Step n={2} title="Choose how to purchase">
            ...
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                <strong style={{ color: 'var(--text)' }}>Buy at listed price</strong> — pay
                immediately with MetaMask
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>Negotiate</strong> — open a chat with the
          ...
          <Step n={4} title="Receive access">
            ...
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.25rem', lineHeight: 2 }}>
              <li>
                <strong style={{ color: 'var(--text)' }}>Repositories</strong> — a download link to
                the code archive
              </li>
              <li>
                <strong style={{ color: 'var(--text)' }}>AI Agents</strong> — API key, webhook
                credentials, or downloadable files depending on what the seller provides
              </li>
            </ul>
          </Step>
          ...
          >
            {[
              ...
              >
                <div style={{ fontSize: '0.8rem', color: '#8b949e', marginBottom: '0.4rem' }}>
                  {label}
                </div>
                <div
                  style={{
          ...
          <Note>
            Bolty never custody your funds between trades. The smart contract releases payment to
            the seller as soon as the on-chain transactions confirm — there is no manual approval
            step.
          </Note>

        ...
        >
          ...
          <div className="flex items-center justify-between px-2">
            <div className="flex items-center gap-2">
              <span className="text-lg font-semibold text-white">Conversations</span>
              <motion.div
            ...
            {showNewDm && (
              ...
              >
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="text-xs py-2 px-3 rounded-lg text-white font-semibold transition-all"
                  style={{
                    background:
          ...
          <div className="relative px-2">
            ...
            <input
              ...
              className="w-full pl-8 pr-8 py-2 text-xs rounded-lg text-white placeholder-zinc-500 outline-none transition-all font-semibold focus:shadow-[0_0_0_1px_rgba(20, 241, 149,0.45),_0_0_0_4px_rgba(20, 241, 149,0.12)]"
              style={{
                background:
                  'linear-gradient(180deg, rgba(20,20,26,0.7) 0%, rgba(10,10,14,0.7) 100%)',
                  ...
                  <div>
                    {activePeer.username ? (
                      <Link
                        ...
                        className="text-sm font-semibold hover:text-bolty-300 transition-colors text-white"
                      >
                        {activePeer.username}
                      </Link>
                    ) : (
                      <p className="text-sm font-semibold text-white">{activePeer.id.slice(0, 8)}</p>
                    )}
                        ...
                        return (
                          ...
                          >
                            {isAgent && (
                              <div className="flex-shrink-0">
                                <motion.div
                                  initial={{ scale: 0 }}
                                  animate={{ scale: 1 }}
                                  className="w-10 h-10 rounded-full bg-gradient-to-br from-bolty-500 to-bolty-600 flex items-center justify-center text-white text-xs font-semibold border-2 border-bolty-400"
                                >
                                  AI
                                </motion.div>
                              </div>
                            ...
                            <div className={`flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                              {isAgent && (
                                <p className="text-xs font-semibold text-bolty-300 mb-1">

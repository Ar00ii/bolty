...
function DisputeRow({
  ...
  return (
    <motion.button
      ...
      style={{
        background: 'linear-gradient(180deg, rgba(30,15,18,0.55) 0%, rgba(10,10,14,0.55) 100%)',
        boxShadow:
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: 'linear-gradient(180deg, rgba(18,18,24,0.98) 0%, rgba(10,10,14,0.98) 100%)',
          boxShadow:

...
export default function InteractiveHoverButton({
  ...
  return (
    <button
      className={cn(
        'group relative flex min-w-40 items-center justify-center overflow-hidden rounded-full border border-bolty-500/40 bg-transparent p-2 px-6 font-light text-white transition-all duration-300',
        classes,
        className,
      )}
      {...props}
...
export function InteractiveHoverLinkInner({
  ...
  return (
    <span
      className={cn(
        'group relative inline-flex items-center justify-center overflow-hidden rounded-full border border-bolty-500/40 bg-transparent py-2 px-6 font-light text-white transition-all duration-300',
        classes,
        className,
      )}
    >

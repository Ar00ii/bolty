...
export function AnimatedGradientText({
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute inset-0 rounded-full p-px [background:linear-gradient(var(--ag-angle,0deg),#14F195,#B3FFD9,#14F195)] animate-[gradientRotate_4s_linear_infinite] opacity-60 group-hover:opacity-100 transition-opacity duration-300"
        style={{

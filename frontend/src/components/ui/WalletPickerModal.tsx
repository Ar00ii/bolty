            ...
            {wallets.map((w) => {
              ...
              return (
                ...
                >
                  ...
                  {active && (
                    <span className="grid place-items-center w-6 h-6 rounded-full bg-bolty-500/20 border border-bolty-500/60 flex-shrink-0">
                      <Check className="w-3.5 h-3.5 text-bolty-300" strokeWidth={3} />
                    </span>
                  )}
                </button>
              );

...
export function FormSection({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-semibold text-white mb-2 tracking-[-0.01em]">{title}</h2>
      ...
      {onSubmit && (
        ...
        >
          <motion.button
            ...
            className="text-white px-5 py-2.5 rounded-lg font-semibold text-[13px] tracking-[0.005em] transition-all hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2"
            style={{
              background:

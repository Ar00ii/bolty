...
const getIconComponent = (id: string) => {
  const icons: Record<string, React.ReactNode> = {
    'metamask': <Wallet className="w-6 h-6" />,
    'walletconnect': <Share2 className="w-6 h-6" />,
    'ledger': <Smartphone className="w-6 h-6" />,
    'twitter': <Share2 className="w-6 h-6" />,
    'discord': <MessageCircle className="w-6 h-6" />,
    'github-social': <Github className="w-6 h-6" />,
    'two-factor': <Shield className="w-6 h-6" />,
    'api-keys': <Key className="w-6 h-6" />,
  };
                ...
                {categoryIntegrations.map((integration) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      `}
                    >
                      {getIconComponent(integration.id)}
                    </div>

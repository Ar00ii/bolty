 ...
 *   3. Footer hint — link to /reputation/leaderboard to see other
 *      users at each tier.
 *
...
const TIER_PERKS: Record<string, string[]> = {
  ...
  CAMPEON: ['Top-5 leaderboard pin', 'Free listing boosts (limited)'],
            ...
            return (
              <li
                ...
                style={{
                  ...
                  border: `1px solid ${
                    isCurrent ? `${tier.color}55` : 'rgba(255,255,255,0.06)'
                  }`,
                }}
              >
                <button
                ...
                >
                  <div
                    ...
                    style={{
                      background: reached ? `${tier.color}1f` : 'rgba(255,255,255,0.03)',
                      border: `1px solid ${
                        reached ? `${tier.color}55` : 'rgba(255,255,255,0.06)'
                      }`,
                    }}
                  >
                    {reached ? (

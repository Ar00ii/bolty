...
export const AgentDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Agent Selector */}
      <div className="relative rounded-xl p-6 overflow-hidden bg-[linear-gradient(180deg,rgba(20,20,26,0.6)_0%,rgba(10,10,14,0.6)_100%)] shadow-[0_0_0_1px_rgba(255,255,255,0.06),inset_0_1px_0_rgba(255,255,255,0.03)] before:content-[''] before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-[linear-gradient(90deg,transparent_0%,rgba(20, 241, 149,0.4)_50%,transparent_100%)] before:pointer-events-none">
        <label className="block text-sm font-semibold text-gray-300 mb-3">Select Agent</label>
        <AgentSelector
          agents={agents}
            ...
            <div className="mt-4 pt-4 border-t border-white/[0.06]">
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  ...
                  className="px-4 py-2 rounded-lg disabled:opacity-50 text-white font-semibold text-[13px] tracking-[0.005em] transition-all hover:brightness-110"
                  style={{
                    background:
      ...
      {!loading && agents.length === 0 && (
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            transition={{ type: 'spring', stiffness: 360, damping: 22 }}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg text-white font-semibold text-[13px] tracking-[0.005em] transition-all hover:brightness-110"
            style={{
              background:
                'linear-gradient(180deg, rgba(20, 241, 149,0.38) 0%, rgba(20, 241, 149,0.14) 100%)',
              boxShadow:

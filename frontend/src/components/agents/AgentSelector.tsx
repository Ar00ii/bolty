    ...
    return (
      <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700 text-center">
        ...
        {onCreateNew && (
          <button
            onClick={onCreateNew}
            className="flex items-center justify-center gap-2 w-full px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-medium transition-colors"
          >
    ...
    <div className="relative">
      ...
      >
        <div className="flex-1 min-w-0">
          {selectedAgent ? (
            <>
              <div className="text-sm font-medium text-white truncate">{selectedAgent.name}</div>

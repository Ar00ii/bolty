      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-light text-white tracking-[-0.005em]">Create New Agent</h3>
          </div>
          <button
            onClick={onClose}
            disabled={submitting}
        ...
        {error && (
          <div
            className="p-3 rounded-lg mb-4 text-[13px] tracking-[0.005em]"
            style={{
              background:
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className="flex-1 px-4 py-2.5 rounded-lg text-zinc-300 hover:text-white disabled:opacity-50 transition-all hover:brightness-110 font-light text-[13px] tracking-[0.005em]"
              style={{
                background:

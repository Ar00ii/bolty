...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    idle(() => {
      ...
      // so the seller-side dashboard lands fully populated.
      ...
      // anything. Empty lists are skipped — we only pay the network
      // cost when there's actually data to fetch.
      // Keys must match useFavorites.ts exactly.
      try {
